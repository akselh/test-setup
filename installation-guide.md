...
| **GitHub CLI** | Logger deg inn på GitHub én gang, etterpå skal git virke uten ny pålogging. Installasjon håndteres automatisk av AI fra [check-installation](check-installation.md) | -                                                                                                                                                                                                                                      | -                                                                                                                                                              |

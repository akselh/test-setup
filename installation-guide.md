...
| **Visual Studio Code** | Her ser du på og endrer filene du får i workshopen. Installasjon håndteres automatisk av AI fra [check-installation](check-installation.md) | - | - |
